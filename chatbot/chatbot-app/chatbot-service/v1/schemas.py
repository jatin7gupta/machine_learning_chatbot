...
validators = {
    ('chat', 'GET'): {'args': {'required': ['expression', 'user'], 'properties': {'expression': {'description': 'Query from user. E.g. I want to book an appointment.', 'type': 'string'}, 'user': {'description': "User's name", 'type': 'string'}}}},
}

filters = {
    ('chat', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'answer': {'type': 'string', 'example': 'The available doctors are, Dr Jhon (Paediatric Dentistry, Mascot), Dr Ruby (Orthodontics, Mascot), Dr Casey (Oral Surgery, Kensignton).'}, 'user': {'type': 'string', 'example': 'Jhon'}}}}, 500: {'headers': None, 'schema': None}},
}
